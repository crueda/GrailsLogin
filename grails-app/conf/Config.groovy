...
grails.plugins.springsecurity.userLookup.userDomainClassName = 'com.hiriko.login.User'
grails.plugins.springsecurity.userLookup.authorityJoinClassName = 'com.hiriko.login.UserRole'
grails.plugins.springsecurity.authority.className = 'com.hiriko.login.Role'
